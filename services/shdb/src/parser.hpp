...
/**
 ** \file /home/ivan/Education/db-shad/public-2025-fall/shdb/src/parser.hpp
...
#ifndef YY_YY_HOME_IVAN_EDUCATION_DB_SHAD_PUBLIC_2025_FALL_SHDB_SRC_PARSER_HPP_INCLUDED
# define YY_YY_HOME_IVAN_EDUCATION_DB_SHAD_PUBLIC_2025_FALL_SHDB_SRC_PARSER_HPP_INCLUDED
// "%code requires" blocks.
#line 9 "/home/ivan/Education/db-shad/public-2025-fall/shdb/src/parser.y"
...
#line 56 "/home/ivan/Education/db-shad/public-2025-fall/shdb/src/parser.hpp"
...
namespace shdb {
#line 192 "/home/ivan/Education/db-shad/public-2025-fall/shdb/src/parser.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // expr
      char dummy2[sizeof (ASTPtr)];

      // column_schema
      char dummy3[sizeof (ColumnSchema)];

      // schema
      char dummy4[sizeof (Schema)];
      ...
      // sort_expr
      char dummy7[sizeof (std::shared_ptr<ASTOrder>)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_INT64 = 32,                            // "int64"
        S_STRING = 33,                           // "string"
        S_VARCHAR = 34,                          // "varchar"
        S_NUM = 35,                              // NUM
        S_NAME = 36,                             // NAME
        S_STRING_LITERAL = 37,                   // STRING_LITERAL
        S_38_ = 38,                              // "="
        S_UMINUS = 39,                           // UMINUS
        S_UNOT = 40,                             // UNOT
        S_ELSE = 41,                             // ELSE
        ...
        S_input = 44,                            // input
        S_schema = 45,                           // schema
        S_column_schema = 46,                    // column_schema
        S_type = 47,                             // type
        S_projection = 48,                       // projection
        S_names_list = 49,                       // names_list
        S_expr_list = 50,                        // expr_list
        S_sort_expr_list = 51,                   // sort_expr_list
        S_sort_expr = 52,                        // sort_expr
        S_expr = 53                              // expr
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_column_schema: // column_schema
        value.move< ColumnSchema > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_sort_expr: // sort_expr
        value.move< std::shared_ptr<ASTOrder> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ColumnSchema&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ColumnSchema& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<ASTOrder>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<ASTOrder>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    {
      ...
      case symbol_kind::S_column_schema: // column_schema
        value.template destroy< ColumnSchema > ();
        break;
      ...
      case symbol_kind::S_sort_expr: // sort_expr
        value.template destroy< std::shared_ptr<ASTOrder> > ();
        break;
    ...
    Parser (shdb::Lexer& lexer_yyarg, ASTPtr & result_yyarg, std::string & message_yyarg);
    virtual ~Parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_ORDER_BY ()
      {
        return symbol_type (token::ORDER_BY);
      }
#else
      static
      symbol_type
...
#line 1961 "/home/ivan/Education/db-shad/public-2025-fall/shdb/src/parser.hpp"




#endif // !YY_YY_HOME_IVAN_EDUCATION_DB_SHAD_PUBLIC_2025_FALL_SHDB_SRC_PARSER_HPP_INCLUDED
