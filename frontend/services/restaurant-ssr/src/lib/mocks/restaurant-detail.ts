import type { Restaurant, RestaurantContentBlock } from "../../types/restaurant";
...
const burgBurgers: RestaurantContentBlock[] = [
  dish("burg-b1", "Двойной чизбургер", 420, "Две говяжьи котлеты, сыр чеддер, соус BBQ"),
  dish("burg-b2", "Чикен делюкс", 390, "Куриная котлета в панировке, майонез, салат"),
  ...
  dish("burg-b9", "Сырная лавина", 430, "Три вида сыра, грибы, трюфельный соус"),
  dish("burg-b10", "Ранч бургер", 400, "Бекон, яйцо всмятку, соус ранч"),
  dish("burg-b11", "Мини-слайдеры ×3", 320, "Три маленьких бургера с разной начинкой"),
  dish("burg-b12", "Барбекю XL", 470, "Копчёная грудинка, луковые кольца, BBQ"),
];

const burgSides: RestaurantContentBlock[] = [
  dish("burg-s1", "Картофель фри", 150, "Большая порция, соль по вкусу", "f39c12"),
  dish("burg-s2", "Картофель по-деревенски", 170, "Дольки со шкуркой, розмарин", "f39c12"),
  dish("burg-s3", "Наггетсы 6 шт", 220, "Куриные наггетсы, соус на выбор", "f39c12"),
  dish("burg-s4", "Крылышки BBQ", 280, "6 шт, карамельный соус", "f39c12"),
  dish("burg-s5", "Салат Цезарь", 240, "Курица, пармезан, соус цезарь", "27ae60"),
  dish("burg-s6", "Луковые кольца", 190, "В кляре, соус сладкий чили", "f39c12"),
];

const burgDrinks: RestaurantContentBlock[] = [
  dish("burg-d1", "Кола 0,5", 120, "В стакане со льдом", "3498db"),
  dish("burg-d2", "Молочный коктейль", 210, "Ваниль / шоколад / клубника", "3498db"),
  dish("burg-d3", "Лимонад домашний", 160, "Мята, лайм, газированная вода", "3498db"),
...
const burgCombos: RestaurantContentBlock[] = [
  dish("burg-c1", "Комбо «Обед»", 520, "Бургер на выбор + картофель + напиток", "c0392b"),
  dish("burg-c2", "Комбо «Семья»", 1290, "2 бургера XL + 2 картофеля + наггетсы + 2 колы", "c0392b"),
  dish("burg-c3", "Комбо «Детское»", 360, "Мини-бургер, наггетсы, сок", "c0392b"),
];
...
const piz1Blocks: RestaurantContentBlock[] = [
  ...
  dish("p1-3", "Четыре сыра", 640, "Моцарелла, горгонзола, пармезан, чеддер", "c0392b"),
  ...
  dish("p1-9", "Кальцоне", 540, "Закрытая пицца с ветчиной и грибами", "c0392b"),
...
const cafe1Blocks: RestaurantContentBlock[] = [
  dish("cf1-1", "Тост с лососем", 420, "Слабосолёный лосось, крем-сыр", "8e44ad"),
  ...
  dish("cf1-8", "Гранола йогурт", 290, "Ягоды, мёд, греческий йогурт", "8e44ad"),
];
...
const nashKitchen: RestaurantContentBlock[] = [
  ...
  dish("nash-k2", "Котлета по-киевски", 410, "Сливочное масло, картофельное пюре", "c0392b"),
  dish("nash-k3", "Салат «Наш»", 280, "Свежие овощи, заправка на выбор", "27ae60"),
];
...
export const mockRestaurantDetails: Record<string, Restaurant> = {
  ...
  piz1: {
    ...
    published: true,
    preview: {
      images: ["https://via.placeholder.com/800x400/c0392b/white?text=Пицца+33"],
      rating: 4.5,
  ...
  cafe1: {
    ...
    published: true,
    preview: {
      images: ["https://via.placeholder.com/800x400/8e44ad/white?text=Тост+и+кофе"],
      rating: 4.7,
    ...
    mainSections: [
      {
        id: "menu",
        title: "Меню",
        divisions: [{ id: "all", title: "Завтраки и напитки", blocks: cafe1Blocks }],
      },
    ],
  },
  cafe2: {
    ...
    published: true,
    preview: {
      images: ["https://via.placeholder.com/800x400/16a085/white?text=Гости+лавки"],
      rating: 4.3,
    ...
    mainSections: [
      {
        id: "menu",
        title: "Меню",
        divisions: [{ id: "home", title: "Домашняя кухня", blocks: cafe2Blocks }],
      },
    ],
  },
};
