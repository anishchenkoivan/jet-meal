...
export function JetMealInfo() {
  return (
    <section className="box-border w-full max-w-[960px] mx-auto px-6 py-16">
      <h2 className="m-0 mb-2 text-[1.75rem] font-bold tracking-[-0.02em]">Почему Jet Meal</h2>
      ...
      <div className="grid gap-5 [grid-template-columns:repeat(auto-fit,minmax(240px,1fr))]">
        <article className="p-[22px] rounded-[14px] bg-white border border-black/[0.06] shadow-[0_8px_24px_rgba(0,0,0,0.04)]">
          ...
          <h3 className="m-0 mb-2 text-[1.05rem] font-semibold">Быстрый старт</h3>
        ...
        <article className="p-[22px] rounded-[14px] bg-white border border-black/[0.06] shadow-[0_8px_24px_rgba(0,0,0,0.04)]">
          ...
          <h3 className="m-0 mb-2 text-[1.05rem] font-semibold">Разнообразие меню</h3>
          <p className="m-0 text-black/55 text-sm leading-[1.55]">
        ...
        <article className="p-[22px] rounded-[14px] bg-white border border-black/[0.06] shadow-[0_8px_24px_rgba(0,0,0,0.04)]">
          ...
          <h3 className="m-0 mb-2 text-[1.05rem] font-semibold">Понятное время</h3>
          <p className="m-0 text-black/55 text-sm leading-[1.55]">
        ...
        <article className="p-[22px] rounded-[14px] bg-white border border-black/[0.06] shadow-[0_8px_24px_rgba(0,0,0,0.04)]">
          ...
          <h3 className="m-0 mb-2 text-[1.05rem] font-semibold">Надёжная оплата</h3>
          <p className="m-0 text-black/55 text-sm leading-[1.55]">
